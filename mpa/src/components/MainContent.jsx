...
import { ... все импорты которые были ... }

export function MainContent({ initialPage = "home" }) {
  const [currentPage, setCurrentPage] = useState(initialPage)

  // ВСЁ ТВОЁ ОГРОМНОЕ СОДЕРЖИМОЕ yC() отсюда и до return
  // Просто скопируй всё из твоего старого App.jsx сюда
  // Только замени const [o,u] = useState("home") → useState(initialPage)
